...
Senior application architect and fractional CTO currently shipping AI-assisted products with Cursor, Claude, and ChatGPT. Previously spent five years at Vistra designing generation, mining, and emissions systems, including a cloud credit-trading platform that accounted for $60 million in profit in the first two months. Named inventor on two U.S. patents. Combines AWS, .NET, SQL, and systems integration with energy, mining, and manufacturing domain expertise, and leads cross-functional teams through the full project lifecycle.
